...
<!--
  ...
  SPDX-FileCopyrightText: 2024 Hana <69644134+ShinniUwU@users.noreply.github.com>
-->
<!DOCTYPE TS>
...
<context>
    ...
    <message>
        ...
        <translation>Файлът %1.json, изискван от редактора, не може да бъде зареден: %2</translation>
    </message>
    <message>
        <location filename="../../src/customeditor/customeditor.cpp" line="349"/>
        <source>Error updating the lighting data.</source>
        <translation>Грешка при актуализиране на подсветката.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Изображението се изтегля...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Неуспешно задаване на DPI</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Заклучи X/Y</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Неуспешна промяна на яркостта</translation>
    </message>
    <message>
        <location filename="../../src/devicewidget/ledwidget.cpp" line="327"/>
        <source>Failed to change effect</source>
        <translation>Неуспешна промяна на ефекта</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Версия на OpenRazer демон:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изображения на устройството:</translation>
    </message>
    <message>
        ...
        <translation>За да покаже изображения на устройството, RazerGenie ще изтегли изображението от връзката, предоставена в кода на OpenRazer демон. Това ще се прави само за устройства, свързани към компютъра и само веднъж (снимките ще бъдат записани на локалния диск). Razer може да събира информация за тези връзки. За точна информация, моля, посетете &lt;a href=&quot;https://www.razer.com/legal/privacy-policy&quot;&gt;Политика за поверителност на Razer&lt;/a&gt;.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Демон бекенд:</translation>
    </message>
    <message>
        <location filename="../../src/preferences/preferences.cpp" line="81"/>
        <source>Download device images</source>
        <translation>Свали изображениятя на устройството</translation>
    </message>
    <message>
        ...
        <translation>Моля, рестартирайте приложението, за да влязат в сила промените.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>OpenRazer демон не е инсталиран</translation>
    </message>
    <message>
...
If you are running RazerGenie as a flatpak, you will still have to install OpenRazer outside of flatpak from a distribution package.</source>
        <translation>Демонът не е инсталиран или версията е твърде остаряла. Моля, следвайте инструкциите за инсталиране на уебсайта!

Ако използвате RazerGenie от flatpak, пак ще трябва да инсталирате OpenRazer извън flatpak от пакетите на вашата дистрибуция.</translation>
    </message>
    <message>
        <location filename="../../src/razergenie.cpp" line="60"/>
        <source>Open OpenRazer website</source>
        <translation>Отворете уебсайта на OpenRazer</translation>
    </message>
    <message>
        ...
        <translation>Отверете настройки</translation>
    </message>
    <message>
        <location filename="../../src/razergenie.cpp" line="76"/>
        <source>The OpenRazer daemon is not available.</source>
        <translation>OpenRazer демонът не е наличен.</translation>
    </message>
    <message>
...
Please consult the documentation for details.</source>
        <translation>Демонът OpenRazer не работи и вие не използвате systemd.
Трябва или ръчно да стартирате демона всеки път, когато влезете, или да използвате друг метод за автоматичното му стартиране.

Вижте документацията за повече подробности.</translation>
    </message>
    <message>
        ...
        <translation>Демонът OpenRazer в момента не е наличен. По-долу е изходът за състоянието.</translation>
    </message>
    <message>
        <location filename="../../src/razergenie.cpp" line="93"/>
        <source>If you think, there&apos;s a bug, you can report an issue on GitHub:</source>
        <translation>Ако смятате, че сте открили грешка, докладвайте за нея на GitHub:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Демонът OpenRazer не е настроен на автоматично стартиране. Щракнете върху „Активиране“ за да използвате пълния потенциал на демона веднага след влизане.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комуникацията с демона чрез DBus беше загубена, вероятно защото демонът крашна.</translation>
    </message>
    <message>
...
This could also be caused due to a misconfiguration of this PC.</source>
        <translation>Демонът OpenRazer не откри поддържано устройство.
Това може да бъде причинено и от неправилни настройки на този компютър.</translation>
    </message>
    <message>
        <location filename="../../src/razergenie.cpp" line="399"/>
        <source>Open supported devices</source>
        <translation>Отворете поддържаните устройства</translation>
    </message>
    <message>
        <location filename="../../src/razergenie.cpp" line="404"/>
        <source>The daemon didn&apos;t detect a device that is connected</source>
        <translation>Демонът не откри свързаното устройство</translation>
    </message>
    <message>
        ...
        <translation>Linux намери устройствата, но демонът не можа. Това може да се дължи на неправилни разрешения или проблем с модула на ядрото.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Грешка при синхронизиране на устройството.</translation>
    </message>
    <message>
        <location filename="../../src/razergenie.cpp" line="437"/>
        <source>Error while toggling &apos;turn off on screensaver&apos;</source>
        <translation>Грешка при деактивиране на скрийнсейвъра</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Синхронизация на устройстава</translation>
    </message>
    <message>
        <location filename="../../ui/razergenie.ui" line="132"/>
        <source>Turn off on screensaver</source>
        <translation>Деактивирайте скрийнсейвъра</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Изтеглянето на изображения е деактивирано</translation>
    </message>
    <message>
        <location filename="../../src/razerimagedownloader.cpp" line="31"/>
        <source>Image downloading is disabled. Visit the preferences to enable it.</source>
        <translation>Изтеглянето на изображения е деактивирано. Активирайте в настройките, ако е необходимо.</translation>
    </message>
    <message>
