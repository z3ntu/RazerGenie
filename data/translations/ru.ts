...
<!--
  ...
  SPDX-FileCopyrightText: 2022 Alexey Minnekhanov <alexey.min@gmail.com>
-->
<!DOCTYPE TS>
...
If you are running RazerGenie as a flatpak, you will still have to install OpenRazer outside of flatpak from a distribution package.</source>
        <translation>Демон не установлени или версия слишком устарела. Подалуйста следуйте инструкциям по установке на сайте!
...
Please consult the documentation for details.</source>
        <translation>Демон OpenRazer не запущен и вы не используете systemd.
Необходимо или запускать демон вручную при каждом входе в систему, или использовать какой-то другой метод для его автозапуска.
...
<context>
    ...
    <message>
        ...
        <translation>Загрузка картинок отключена</translation>
    </message>
    <message>
        <location filename="../../src/razerimagedownloader.cpp" line="31"/>
        <source>Image downloading is disabled. Visit the preferences to enable it.</source>
        <translation>Загрузка картинок отключена. Включите в настрйоках, если нужно.</translation>
    </message>
    <message>
